    ...
    <div class="main-body">
        ...
        <div id="Div1">
            ...
            <?php
                ...
                where p.user_id = '$uid' and p.user_id = u.user_id and s.service_no = u.service_no and s.pincode = addr.pincode;"); 
               //-----------------------------------------------------------------------------------
                //-----------------------------------------------------------------------------------
                //CHANGE SQL QUARY HERE FOR CUSTOMER FETCH FROM FEED BACK 
                //-----------------------------------------------------------------------------------
                ...
                ?>
                <form  id="form" action="updateCustomerDetails.php" method="post">
                    <div>                    
                    ...
                    <div>
                        ...
                        <input type=" text" name="auto" id="auto" Value="<?php if((string)$row["auto_renewal"] == 1){
                            echo "Yes";
                        }else{
                            echo "No";
                        }; ?>" readonly>
               ...
               //-----------------------------------------------------------------------------------
                ...
                <form  id="form" action="updateCustomerDetails.php" method="post">
                    ...
                    <div style="background-color: var(--grey); color: var(--white); box-shadow: 0px 0px 0px 0px white;">
                        <label for="userId">User Id:</label>
                        <input style="background-color: var(--grey);" type="tel" id="userId" name="userId" placeholder="12345678" pattern="[1-9]{1}[0-9]{7}" value="<?php echo $row["user_id"]."(read-only)"; ?>"  >
                    </div>
                    <div id="show">
                        <label for="pass">Password</label> 
                    ...
                    <div>
                        <label for="auto">Auto Renewal:</label>
                        <input type=" text" name="auto" id="auto" Value="<?php echo (string)$row["auto_renewal"]; ?>" >
                    </div>
                    <h4 style="padding: 20px 70px; padding-left: 70px;">Address:</h2>
                    <div>
                        <label for="city">City:</label>
