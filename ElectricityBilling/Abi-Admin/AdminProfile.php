    ...
    <div class="main-body">
        ...
        <div id="Div1">
            ...
            <?php
                ...
                //-----------------------------------------------------------------------------------
                //-----------------------------------------------------------------------------------
                $result = mysqli_query($connection,"SELECT * FROM user_details where user_id='$adminid'");
               //-----------------------------------------------------------------------------------
                //-----------------------------------------------------------------------------------
                //CHANGE SQL QUARY HERE FOR CUSTOMER FETCH FROM FEED BACK 
                //-----------------------------------------------------------------------------------
               ...
               //-----------------------------------------------------------------------------------
                ...
                <form  id="form" action="updateAdminDetails.php">
                    ...
                    <div style="background-color: var(--grey); color: var(--white);">
                        ...
                        <input style="background-color: var(--grey);" type="tel" id="adminId" name="adminId" placeholder="12345678" pattern="[1-9]{1}[0-9]{7}" value="<?php echo $row["user_id"]."(read-only)"; ?>"readonly>
                    </div>
