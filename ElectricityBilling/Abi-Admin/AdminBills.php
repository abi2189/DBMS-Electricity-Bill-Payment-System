...
<!-- <div class="header">
        ...
        <div class="new box">
            <div class="Customer-table">
                ...
                <?php
                include_once 'db.php';
                $result = mysqli_query($connection,"SELECT * FROM Bill_details where transaction_id IS NOT NULL");
                ?>
                <?php
        ...
        <div class="defaulters box">
            <div class="Customer-table">
                ...
                <?php
                include_once 'db.php';
                $result = mysqli_query($connection,"SELECT * FROM Bill_details where transaction_id IS NULL" );
                ?>
                <?php
                if (mysqli_num_rows($result) > 0) {
                ?>
                ...
                <td><?php echo $row["bill_no"]; ?></td>
                <td><?php if($row["transaction_id"] == NULL){
                    echo 'UNPAID';
                }; ?></td>
                <td><?php echo $row["bill_amt"]; ?></td>
                <td><?php echo $row["bill_area"]; ?></td>
