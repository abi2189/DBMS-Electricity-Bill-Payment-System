...
<!-- <div class="header">
        ...
        <div class="search">
            ...
            <div class="filter">
                ...
                <select>
                    <option value="new">Payment Successfull</option>
        ...
        <div class="new box">
            <div class="Customer-table">
                ...
                //-----------------------------------------------------------------------------------
                //-----------------------------------------------------------------------------------
                //CHANGE SQL QUARY HERE FOR FEEDBACK FETCH FROM FEED BACK 
                //-----------------------------------------------------------------------------------
                //-----------------------------------------------------------------------------------
                $result = mysqli_query($connection,"SELECT * FROM Payment_details where transaction_id='8435327687' or  transaction_id='2757208823' or transaction_id='6863803935' or transaction_id='8485327687' or transaction_id='6869803935'");
               //-----------------------------------------------------------------------------------
                //-----------------------------------------------------------------------------------
                //CHANGE SQL QUARY HERE FOR FEEDBACK FETCH FROM FEED BACK 
                //-----------------------------------------------------------------------------------
        ...
        <div class="defaulters box">
            <div class="Customer-table">
                ...
                //-----------------------------------------------------------------------------------
                //-----------------------------------------------------------------------------------
                $result = mysqli_query($connection,"SELECT * FROM Payment_details where transaction_id='8546509433' or  transaction_id='8485327687' or transaction_id='6869803935' or transaction_id='8546502433' or transaction_id='8485357687' or transaction_id='6369803935' or transaction_id='8546549433'");
               //-----------------------------------------------------------------------------------
                //-----------------------------------------------------------------------------------
                //CHANGE SQL QUARY HERE FOR FEEDBACK FETCH FROM FEED BACK 
                //-----------------------------------------------------------------------------------
        ...
        <div class="viewAll box">
            <div class="Customer-table">
                ...
                //-----------------------------------------------------------------------------------
                //-----------------------------------------------------------------------------------
                $result = mysqli_query($connection,"SELECT * FROM Payment_details ");
               //-----------------------------------------------------------------------------------
                //-----------------------------------------------------------------------------------
                //CHANGE SQL QUARY HERE FOR FEEDBACK FETCH FROM FEED BACK 
                //-----------------------------------------------------------------------------------
