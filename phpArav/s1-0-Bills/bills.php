        ...
        <div class="bigContainer">
            ...
            <div class="bills-main b1">
                <?php
                    include_once 'db.php';
                    $user_id = 'yvo809';
                    $result = mysqli_query($connection,"SELECT * FROM bill_details WHERE user_id = '$user_id' and issue_date = '2021-12-12'");
                ...
                <?php
                    include_once 'db.php';
                    // $user_id = 'yvo809';
                    $result = mysqli_query($connection,"SELECT * FROM bill_details WHERE user_id = '$user_id' and issue_date = CURRENT_DATE();");
                    $row = mysqli_fetch_array($result);
                ?>
            ...
            <div class="bills-main b2">
                ...
                include_once 'db.php';
                // $user_id = 'yvo809';
                $result = mysqli_query($connection,"SELECT * FROM bill_details WHERE user_id = '$user_id' and issue_date < CURRENT_DATE() ORDER BY issue_date ASC");
                $i = 0;
